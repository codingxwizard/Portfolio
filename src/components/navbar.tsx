    ...
    return (
        ...
        <nav className="bg-[#000000] dark:bg-[#000000] w-full z-20 top-0 left-0">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-[#000000] md:dark:bg-[#000000] dark: border-gray-700">
                <li>
                <a href="#" className="block py-2 pl-3 pr-4 text-white bg-[#750F87] rounded md:bg-transparent md:text-[#750F87] md:dark:text-white hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#750F87] md:p-0 md:dark:hover:text-[#750F87]">Services</a>
                </li>
                <li>
                <a href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#750F87] md:p-0 md:dark:hover:text-[#750F87] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Portfolio</a>
                </li>
                <li>
                <a href="#" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#750F87] md:p-0 md:dark:hover:text-[#750F87] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About Us</a>
                </li>
            </ul>
              </div>
            </div>

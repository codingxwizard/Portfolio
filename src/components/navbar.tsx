...
export default function NavBar() {
    return (
        <nav className="bg-black w-full fixed bg-opacity-50 backdrop-blur-xl z-20 top-0">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link href="/" className="flex items-center">
                    <img src="/logo.png" className="h-10" alt="CW"></img>
                    {/* <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Coding Wizards</span> */}
                </Link>
                <div className="flex md:order-2">
                    <button type="button" className="text-white bg-[#750F87] hover:bg-[#750F87] focus:outline-none font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-[#750F87] dark:hover:bg-[#750F87]">Contact Us</button>
                    <button type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700">

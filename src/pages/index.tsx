...
export default function Home() {
	...
	return (
		<>
			...
			<main className="bg-black max-w-full flex flex-col gap-20">
				<NavBar />
				<HomeBack />
				<AboutUs />
				<SkillCards />
				<Skills />
				<div className="h-[500px] bg-[url('/portal.png')] bg-center bg-cover justify-center items-center gap-2 flex flex-col">
					<h1 className="tracking-widest text-7xl">PORTAL OF WIZARDRY</h1>
					<h3 className="text-white text-2xl font-medium text-center">A Selected List of Recent Work</h3>
				</div>
				<div className="flex md:flex-row flex-col gap-10 justify-center">
					<div className="flex flex-col md:w-2/3 w-full items-center md:px-28 px-10 gap-5">
						<h1>MEET THE WIZARDS</h1>
						<img src="/meet.png" className="w-[80%] rounded"></img>
						<p className="text-white w-[80%] text-center text-xl">
